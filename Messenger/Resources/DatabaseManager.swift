...
extension DatabaseManager {
    ...
    /// Create a new conversation with targer user email and first message sent
...
struct ChatAppUser {
    ...
    var profilePictureName: String {
        // bongbong9708-gmail-com_profile_picture.png
